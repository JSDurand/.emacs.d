(let ((file-name-handler-alist nil))
  ...
  (custom-set-variables
   ...
   '(org-capture-templates
	...
	(file+headline "~/org/Mnote.org" "MaoBaoBao Notes")
	"* day %T %?")
   ...
   '(package-selected-packages
     (quote
      (ox-reveal htmlize slime lispy org-bullets pacmacs rainbow-mode magit dired-details company-flx counsel tex auctex yasnippet wrap-region company-math company paredit expand-region iy-go-to-char org org-mode use-package)))
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (esup ox-reveal htmlize slime lispy org-bullets pacmacs rainbow-mode magit dired-details company-flx counsel tex auctex yasnippet wrap-region company-math company paredit expand-region iy-go-to-char org org-mode use-package)))
 '(wrap-region-global-mode t nil (wrap-region)))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
